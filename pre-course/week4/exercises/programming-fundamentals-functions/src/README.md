`#programming-fundamentals` `#functions` `#assembler-school` `#master-in-software-development`

# Assembler School: Programming Fundamentals - Functions Exercises <!-- omit in toc -->

With these exercises pill you'll learn how to use functions.
...
```bash
$ git clone https://github.com/assembler-school/programming-fundamentals-functions.git
```
