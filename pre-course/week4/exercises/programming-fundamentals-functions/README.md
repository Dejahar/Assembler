`#programming-fundamentals` `#functions` `#assembler-institute` `#master-in-software-development`

# Assembler Institute: Programming Fundamentals - Functions Exercises <!-- omit in toc -->

With these exercises pill you'll learn how to use functions in your code.
...
```bash
$ git clone https://github.com/assembler-institute/programming-fundamentals-functions.git
```
